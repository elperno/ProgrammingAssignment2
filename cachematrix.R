## makeCacheMatrix and cacheSolve will be used to cache the value of 
## an inverse matrix, which is typically an expensive operation, so
## that in the case we need to use that inverse multiple times, it
## will only be computed once, and later reused.
